...
export default function About() {
  return <>
    ...
    <section className="story">
      <div className="portrait-placeholder large"><Image src={ownerImage} alt="Tam, owner of Tamed By Tam" fill sizes="(max-width: 900px) 100vw, 40vw" style={{ objectFit: "cover", objectPosition: "center top" }} /></div>
